...
public class Tab1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Recycler view
        recyclerView=(RecyclerView)rootView.findViewById(R.id.Recyclertab1);
    ...
    private ArrayList<Model> getListItems(){
        ...
        Model m=new Model("image1",R.drawable.image);
        listitems.add(m);
        m=new Model("image2",R.drawable.image);
        listitems.add(m);
        m=new Model("image3",R.drawable.image);
        listitems.add(m);
        return listitems;
    }
    @Override
